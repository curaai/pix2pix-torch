...
class G(nn.Module):
    ...
    layer1 : ? x 32 x 32 x 64
    layer2 : ? x 16 x 16 x 128
    ...
    def build(self):
        ...
        self.layer0_1 = conv_block('0_1', self.name, 32, 32, acitvation)
        ...
        self.layer5_1 = conv_block('5_1', self.name, 1024, 1024, activation)
        ...
        self.dlayer4_1 = conv_block('up4_1', self.name, 512, 512, activation)
        ...
        self.dlayer3_1 = conv_block('up3_1', self.name, 256, 256, activation)
    ...
    def forward(self, x):
        ...
        out5_1 = self.layer5_1(out5_0)
        out5_2 = self.layer5_2(out5_1)

        cat_out5_2 = torch.cat((out5_2, out4_2), 3)
        dout4_0 = self.dlayer4_0(cat_out5_2)
        dout4_1 = self.dlayer4_1(dout4_0)
        dout4_2 = self.dlayer4_2(dout4_1)

        cat_out4_2 = torch.cat((dout4_2, out3_2), 3)
        dout3_0 = self.dlayer3_0(cat_out4_2)
        dout3_1 = self.dlayer3_1(dout3_0)
        dout3_2 = self.dlayer3_2(dout3_1)

        cat_out3_2 = torch.cat((dout3_2, out2_2), 3)
        dout2_0 = self.dlayer2_0(cat_out3_2)
        dout2_1 = self.dlayer2_1(dout2_0)

        cat_out2_1 = torch.cat((dout2_1, out1_1), 3)
        dout1_0 = self.dlayer1_0(cat_out2_1)
        dout1_1 = self.dlayer1_1(dout1_0)

        cat_out1_1 = torch.cat((dout1_1, out0_1), 3)
